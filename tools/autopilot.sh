...
echo "📖 This script will help you running the timeline service for the first time. It will try to setup everything"
...
echo "🏁 Autopilot completed. You should be able to go to your web browser and access the application at http://localhost:8505/docs."
